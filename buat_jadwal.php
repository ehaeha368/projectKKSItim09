              ...
              <div class="col-lg-12 mb-5">
                <div class="card">
                  <div class="card-header">
                    <h3 class="h6 text-uppercase mb-0">Tambah Jadwal pelajaran</h3>
                  </div>
                  <div class="card-body">
...
?>
	...
	<form action="buat_jadwal2.php" method="post" >
	<table class="table table-light"  width="319" border="0">
...
<tr>
	<td>KELAS </td>
	<td>
			<select name='kelas' value="<?php echo $d['kelas']; ?>"><?php echo $d ['kelas'];?>
...
<tr>
	<td>Jam</td>
	<td>
			<select name='jam' value="<?php echo $d['kode']; ?>"><?php echo $d ['kode'];?>
			<?php while ($d = mysqli_fetch_array($data)){;?>
...
<tr>
			...
			<td>
			<select name='senin' value="<?php echo $d['mapel']; ?>"><?php echo $d ['mapel'];?>
			<?php while ($d = mysqli_fetch_array($data)){;?>
...
<tr>
			...
			<td width="54">
			<select name='selasa' value="<?php echo $d['mapel']; ?>"><?php echo $d ['mapel'];?>
			<?php while ($d = mysqli_fetch_array($data)){;?>
			<option value ='<?php echo $d['mapel']; ?>'><?php echo $d['mapel'];?></option>
			<?php
			}
...
<tr>
			<td width="50">Rabu</td>
			<td width="54">
			<select name='rabu' value="<?php echo $d['mapel']; ?>"><?php echo $d ['mapel'];?>
			<?php while ($d = mysqli_fetch_array($data)){;?>
			<option value ='<?php echo $d['mapel']; ?>'><?php echo $d['mapel'];?></option>
			<?php
			}
...
?>
		<tr>
			...
			<td width="54">
			<select name='kamis' value="<?php echo $d['mapel']; ?>"><?php echo $d ['mapel'];?>
			<?php while ($d = mysqli_fetch_array($data)){;?>
			<option value ='<?php echo $d['mapel']; ?>'><?php echo $d['mapel'];?></option>
			<?php
			}
...
?>
		<tr>
			...
			<td width="54">
			<select name='jumat' value="<?php echo $d['mapel']; ?>"><?php echo $d ['mapel'];?>
			<?php while ($d = mysqli_fetch_array($data)){;?>
			<option value ='<?php echo $d['mapel']; ?>'><?php echo $d['mapel'];?></option>
			<?php
			}
...
?>
		<tr>
			...
			<td width="54">
			<select name='sabtu' value="<?php echo $d['mapel']; ?>"><?php echo $d ['mapel'];?>
			<?php while ($d = mysqli_fetch_array($data)){;?>
			<option value ='<?php echo $d['mapel']; ?>'><?php echo $d['mapel'];?></option>
			<?php
			}
...
<td width="92"> <button class="btn btn-info" type="submit">Simpan</a></button></td>
    ...
    <td width="92"><button class="btn btn-info" href="data_guru.php" href="data_jam.php" type="button" onclick="history.back()">Batal</button></td>
