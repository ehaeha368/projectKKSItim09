   ...
   <div class="d-flex align-items-stretch">
      <div id="sidebar" class="sidebar py-3">
        ...
        <ul class="sidebar-menu list-unstyled">
              ...
              <li class="sidebar-list-item"><a href="jadwal2.php" class="sidebar-link text-muted active "><i class="o-table-content-1 mr-3 text-gray"></i><span>Jadwal pelajaran</span></a></li>
