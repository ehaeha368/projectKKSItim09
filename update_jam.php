    ...
    <div class="d-flex align-items-stretch">
      <div id="sidebar" class="sidebar py-3">
        ...
        <ul class="sidebar-menu list-unstyled">
              ...
              <li class="sidebar-list-item"><a href="data_jam.php" class="sidebar-link text-muted active "><i class="o-clock-1 mr-3 text-gray"></i><span>Data jam</span></a></li>
              ...
              <div class="col-lg-12 mb-5">
                <div class="card">
                  <div class="card-header">
                    <h3 class="h6 text-uppercase mb-0">Update Data Jam</h3>
                  </div>
                  <div class="card-body">
...
<form action="update_jam2.php" method="post">
<?php
$no = $_GET['id'];?>
...
$data = mysqli_query($conn,"SELECT kode,


jam1, jam2 from jam where kode='$no'");
...
<tr>
		...
		<td width="54">
			<input name="kode2" type="hidden" id="kode" value="<?php echo $d['kode']; ?>" size="20" /></td>
		</tr>
		<tr>

			<td width="50">Jam masuk</td>
			<td width="54">
			<input name="jam1" type="time" id="jam1" value="<?php echo $d['jam1']; ?>" size="20" /></td>
		</tr>
		<tr>
			
			<td width="50">Jam selesai</td>
			<td width="54">
			<input name="jam2" type="time" id="jam2" value="<?php echo $d['jam2']; ?>" size="20" /></td>
		</tr>
