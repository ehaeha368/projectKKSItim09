              ...
              <div class="col-lg-12 mb-5">
                <div class="card">
                  <div class="card-header">
                    <h3 class="h6 text-uppercase mb-0">Update Jadwal Pelajaran</h3>
                  </div>
                  <div class="card-body">
...
<form action="update_mapel2.php" method="post">
<?php
$no = $_GET['id'];?>
...
$data = mysqli_query($conn,"SELECT mapel from pelajaran where mapel='$no'");
...
<tr>
			...
			<td width="54">
			<input name="mapel" type="text" id="mapel" value="<?php echo $d['mapel']; ?>" size="20" /></td>
		</tr>
		<td width="54">
			<input name="mapel2" type="hidden" id="mapel" value="<?php echo $d['mapel']; ?>" size="20" /></td>
		</tr>
