    ...
    <div class="d-flex align-items-stretch">
      <div id="sidebar" class="sidebar py-3">
        ...
        <ul class="sidebar-menu list-unstyled">
              ...
              <li class="sidebar-list-item"><a href="data_guru.php" class="sidebar-link text-muted active"><i class="o-user-1 mr-3 text-gray"></i><span>Data guru</span></a></li>
              ...
              <div class="col-lg-12 mb-5">
                <div class="card">
                  <div class="card-header">
                    <h3 class="h6 text-uppercase mb-0">Update Data guru</h3>
                  </div>
                  <div class="card-body">
...
<form action="update_guru2.php" method="post">
<?php
$no = $_GET['id'];?>
...
$data = mysqli_query($conn,"SELECT nama_guru, kode, mapel from guru where nama_guru='$no'");
...
<tr>
      ...
      <td width="54">
      <input name="nama_guru" type="text" id="nama_guru" value="<?php echo $d['nama_guru']; ?>" size="20" /></td>
    </tr>
    <tr>
      <input name="nama_guru2" type="hidden" id="nama_guru2" size="20" /></td>
    </tr>
    <tr>
      <td width="50">kode</td>
      <td width="54">
      <input name="kode" type="text" id="kode" value="<?php echo $d['kode']; ?>" size="20" /></td>
    </tr>
    <?php 
...
<tr>
  ...
  <td>
      <select name="mapel" id='mapel' value="<?php echo $d['mapel']; ?>"><?php echo $d ['mapel'];?>
...
<td width="92"><button class="btn btn-info" type="submit">Simpan</a></button></td>
    <td width="92"><button class="btn btn-info"  href="data_kelas.php" type="button" onclick="history.back()">Batal</button></td>
