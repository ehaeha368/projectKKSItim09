              ...
              <div class="col-lg-12 mb-5">
                <div class="card">
                  <div class="card-header">
                    <h3 class="h6 text-uppercase mb-0">Tambah guru</h3>
                  </div>
                  <div class="card-body">
...
<form action="tambah_guru2.php" method="post" >
  <table align="center" class="table table-light"  width="319" border="0">
    <tr>
      <td width="50">Nama Guru</td>
      <td width="54">
      <input name="nama_guru" type="text" id="nama_guru" size="20" /></td>
    </tr>
    <tr>
      <td width="50">kode</td>
      <td width="54">
...
<tr>
  ...
  <td>
      <select name='mapel' value="<?php echo $d['mapel']; ?>"><?php echo $d ['mapel'];?>
