              ...
              <div class="col-lg-12 mb-5">
                <div class="card">
                  <div class="card-header">
                    <h3 class="h6 text-uppercase mb-0">Manage data jam</h3>
                  </div>
                  <div class="card-body">
...
<?php
	...
	$no=1;
	$sqlCount = "select count(kode) from jam";
	...
	$sql_limit = "select * from jam order by kode limit
	$mulai_dari, $limit";
...
<tr class="success">
	...
	<td>
		<a href= "update_jam.php?id=<?php echo

			$data[1];?>" class="update">Update</a>

				<a href= "hapus_jam.php?id=<?php echo$data[1];?>" class="delete" onclick= "javascript:return confirm('Anda yakin menghapus data  <?php
				echo $data[1];?>?')">Hapus</a>
	</td>
</tr>
...
<?php
	...
	for($i = 1; $i <= $banyakHalaman; $i++){
		if($page != $i){
			echo '<a href="data_jam.php?page='.$i.'">'.$i.'
...
<form>
<button class="btn btn-primary shadow-px-5" formaction="tambah_jam.php" />Tambah Data</button></form>
</div>
</div>
</div>
</div>
