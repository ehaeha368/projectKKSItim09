              ...
              <div class="col-lg-12 mb-5">
                <div class="card">
                  <div class="card-header">
                    <h3 class="h6 text-uppercase mb-0">Tambah jam</h3>
                  </div>
                  <div class="card-body">
...
<form action="tambah_jam2.php" method="post" >
  <table align="center" class="table table-light"  width="319" border="0">
    <tr>
      <td width="50">Kode</td>
      <td width="54">
      <input name="kode" type="text" id="kode" size="20" /></td>
    </tr>
    <tr>

      <td width="50">Jam masuk</td>
      <td width="54">
      <input name="jam1" type="time" id="jam1" size="20" /></td>
    </tr>
    <tr>
      <td width="50">Jam selesai</td>
      <td width="54">
      <input name="jam2" type="time" id="jam2" size="20" /></td>
    </tr>
  </table>
<br/>
...
<table width border="0">
  <tr>
    ...
    <td width="92"><button class="btn btn-info" href="data_jam.php" type="button" onclick="history.back()">Batal</button></td>
