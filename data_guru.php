              ...
              <div class="col-lg-12 mb-5">
                <div class="card">
                  <div class="card-header">
                    <h3 class="h6 text-uppercase mb-0">Manage data guru</h3>
                  </div>
                  <div class="card-body">
...
<?php
	...
	$no=1;
	$sqlCount = "select count(nama_guru) from guru";
	...
	$sql_limit = "select * from guru order by nama_guru limit
	$mulai_dari, $limit";
...
<tr class="success">
	...
	<td>
		<a href= "update_guru.php?id=<?php echo

			$data[1];?>" class="update">Update</a>

				<a href= "hapus_guru.php?id=<?php echo$data[1];?>" class="delete" onclick= "javascript:return confirm('Anda yakin menghapus data  <?php
				echo $data[1];?>?')">Hapus</a>
	</td>
</tr>
...
<?php
	...
	for($i = 1; $i <= $banyakHalaman; $i++){
		if($page != $i){
			echo '<a href="data_guru.php?page='.$i.'">'.$i.'
...
<form>
<button class="btn btn-primary shadow-px-5" formaction="tambah_guru.php" />Tambah Data</button></form>
</div>
</div>
</div>
</div>
