    ...
    <div class="d-flex align-items-stretch">
      <div id="sidebar" class="sidebar py-3">
        ...
        <ul class="sidebar-menu list-unstyled">
              ...
              <li class="sidebar-list-item"><a href="data_mapel.php" class="sidebar-link text-muted active"><i class="o-imac-screen-1 mr-3 text-gray"></i><span>Data mapel</span></a></li>
              ...
              <div class="col-lg-12 mb-5">
                <div class="card">
                  <div class="card-header">
                    <h3 class="h6 text-uppercase mb-0">Manage data mata pelajaran</h3>
                  </div>
                  <div class="card-body">
...
<?php
	...
	$no=1;
	$sqlCount = "select count(mapel) from pelajaran";
	...
	$sql_limit = "select * from pelajaran order by mapel limit
	$mulai_dari, $limit";
...
<tr class="success">
	...
	<td>
		<a href= "update_mapel.php?id=<?php echo

			$data[1];?>" class="update">Update</a>

				<a href= "hapus_mapel.php?id=<?php echo$data[1];?>" class="delete" onclick= "javascript:return confirm('Anda yakin menghapus data  <?php
				echo $data[1];?>?')">Hapus</a>
	</td>
</tr>
...
<?php
	...
	for($i = 1; $i <= $banyakHalaman; $i++){
		if($page != $i){
			echo '<a href="data_mapel.php?page='.$i.'">'.$i.'
